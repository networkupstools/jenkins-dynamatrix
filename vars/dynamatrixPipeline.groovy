 ...
 */
            ...
            parInitial["Quick builds"] = {
                stage("Discover quick build matrix") {
                     ...
                     */
                } // sub-stage - discover the quick matrix
                ...
                stage("Run quick tests") {
                    ...
                    try {
                        ...
                        echo "[ERROR] Something failed in the parallel quick test stage: ${t}"
                        currentBuild.result = 'FAILURE'
                    }

                    echo "Completed the 'Quick tests' stage"
                } // sub-stage-quick tests
            } // stage quick builds

            try {
                parallel parInitial
            } catch (Throwable t) {
                echo "[ERROR] Something failed in the parallel quick test and discovery stage: ${t}"
                currentBuild.result = 'FAILURE'
            }

            if (dynacfgPipeline?.slowBuild && dynacfgPipeline.slowBuild.size() > 0) {
                echo "Completed the 'Quick tests' and 'Slow-build discovery' stage"
            } else {
                echo "Completed the 'Quick tests' stage"
            }
        } // stage-initial
